...
impl<'a> FontInfo<'a> {
  ...
  pub fn create<'bldr: 'args, 'args: 'mut_bldr, 'mut_bldr>(
    ...
    args: &'args FontInfoArgs<'args>
  ) -> flatbuffers::WIPOffset<FontInfo<'bldr>> {
  ...
  #[inline]
  pub fn guidelines(&self) -> Option<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<Guideline<'a>>>> {
    self._tab.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<Guideline>>>>(FontInfo::VT_GUIDELINES, None)
  }
}
...
impl flatbuffers::Verifiable for FontInfo<'_> {
  ...
  fn run_verifier(
    ...
    v.visit_table(pos)?
     ...
     .visit_field::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'_, flatbuffers::ForwardsUOffset<Guideline>>>>("guidelines", Self::VT_GUIDELINES, false)?
     .finish();
    Ok(())
  }
}
pub struct FontInfoArgs<'a> {
    ...
    pub guidelines: Option<flatbuffers::WIPOffset<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<Guideline<'a>>>>>,
}
...
impl<'a: 'b, 'b> FontInfoBuilder<'a, 'b> {
  ...
  #[inline]
  pub fn add_guidelines(&mut self, guidelines: flatbuffers::WIPOffset<flatbuffers::Vector<'b , flatbuffers::ForwardsUOffset<Guideline<'b >>>>) {
