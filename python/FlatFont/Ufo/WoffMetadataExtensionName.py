...
class WoffMetadataExtensionName(object):
    __slots__ = ['_tab']

    @classmethod
    def GetRootAs(cls, buf, offset=0):
        n = flatbuffers.encode.Get(flatbuffers.packer.uoffset, buf, offset)
        x = WoffMetadataExtensionName()
        x.Init(buf, n + offset)
        return x

    @classmethod
    def GetRootAsWoffMetadataExtensionName(cls, buf, offset=0):
...
def WoffMetadataExtensionNameStart(builder):
...
def WoffMetadataExtensionNameAddText(builder, text):
...
def WoffMetadataExtensionNameAddLanguage(builder, language):
...
def WoffMetadataExtensionNameAddDir(builder, dir):
...
def WoffMetadataExtensionNameAddClass_(builder, class_):
    """This method is deprecated. Please switch to AddClass_."""
    return AddClass_(builder, class_)
def End(builder): return builder.EndObject()
def WoffMetadataExtensionNameEnd(builder):
